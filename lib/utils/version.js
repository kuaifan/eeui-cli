...
let iosVersionFile          = path.resolve(process.cwd(), "../eeui-template/plugins/ios/eeui/eeui/eeuiVersion.m");
let iosPodspecFile          = path.resolve(process.cwd(), "../eeui-template/plugins/ios/eeui/eeui.podspec");
