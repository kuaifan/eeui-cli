...
function invokeScript(op, isInstall, callback) {
    ...
    let ideModulesRege = new RegExp("<module fileurl=\"(.*?)/plugins/android/networkTransfer/eeui_" + op.name + ".iml\" filepath=\"(.*?)/plugins/android/networkTransfer/eeui_" + op.name + ".iml\"+\\s*/>", "g");
